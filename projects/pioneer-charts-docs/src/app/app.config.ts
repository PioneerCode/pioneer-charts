...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // compiled listener wrapping regardless of the originating D3-native DOM event (see
    // CLAUDE.md), so this should stay silent - keeping it on permanently costs nothing and is
